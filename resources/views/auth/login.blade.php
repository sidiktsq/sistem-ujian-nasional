    ...
    <form method="POST" action="{{ route('login') }}" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="Masukkan Email " required autofocus autocomplete="off">
            </div>
        </div>
        <div class="form-group">
        ...
        <div style="text-align: center; margin: 20px 0; color: var(--text-muted); font-size: 14px;">
            atau
        </div>
