...
<div style="max-width:800px">
    <div class="card">
        ...
        <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--border);">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; background: rgba(16,185,129,0.05); padding: 16px; border-radius: 12px; border: 1px solid rgba(16,185,129,0.2);">
                <div>
                ...
                <a href="{{ route('murid.profile.settings') }}" class="btn btn-secondary btn-sm">
