...
class ProfileController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('murid.profile.show', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('murid.profile.show')
    ...
    public function uploadAvatar(Request $request)
    {
        ...
        return redirect()->route('murid.profile.settings')
    ...
    public function deleteAccount(Request $request)
    {
        ...
        // Delete related data (exam sessions)
        $user->examSessions()->delete();
    ...
    {
        return view('murid.profile.settings');
    }
}
